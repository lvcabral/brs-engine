...
*   The method `ifAudioResource.maxSimulStreams()` is not implemented yet.
*   The signature of `Sub Main()` does not support the optiona AA parameter.
