...
|`setDisplayMode(mode)`<br>Configure the display mode. If a channel is running will reset the device | `mode` (string) - Supported modes: `"480p"` (SD), `"720p"` (HD) or `"1080p"`(FHD)|
