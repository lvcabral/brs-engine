...
export class ContentNode extends Node {
    readonly defaultFields: FieldModel[] = [
        ...
        { name: "audioWhitelist", type: "string", hidden: true },
        { name: "bookmarkPosition", type: "integer", hidden: true },
        { name: "captionBlacklist", type: "string", hidden: true },
        { name: "captionWhitelist", type: "string", hidden: true },
        ...
        { name: "contentClassifier", type: "string", hidden: true }, // Introduced in OS 13.0
        ...
        { name: "drmHttpCertificatesFile", type: "string", hidden: true },
        ...
        { name: "forwardDashQueryStringParams", type: "boolean", hidden: true },
