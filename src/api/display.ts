...
import { captionColors, captionOpacities, captionsOptions, captionSizes, platform, captionFonts } from "../core/common";
...
// Set/Get Closed Captions State
export function setCaptionState(enabled: boolean) {
