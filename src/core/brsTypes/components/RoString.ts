...
export class RoString extends BrsComponent implements BrsValue, Comparable, Unboxable {
    ...
    /**
     * Built on first method access rather than in the constructor: an roString is allocated for
     * every boxed string in the engine — including one per node field default via
     * `Field.convertValue` — and its ~26 method Callables dominated that cost while almost no
     * instance ever has a method called on it.
     */
     ...
     */
    private get setString(): Callable {
        return new Callable(
            "SetString",
            {
                signature: {
    ...
    private get getString(): Callable {
        return new Callable("GetString", {
            signature: {
                args: [],
    ...
    private get arg(): Callable {
        return new Callable("Arg", {
            signature: {
                args: [
    ...
    private get appendString(): Callable {
        return new Callable("AppendString", {
            signature: {
                args: [new StdlibArgument("s", ValueKind.String), new StdlibArgument("len", ValueKind.Int32)],
                returns: ValueKind.Void,
            },
    ...
    private get len(): Callable {
        return new Callable("Len", {
            signature: {
                args: [],
    ...
    private get left(): Callable {
        return new Callable("Left", {
            signature: {
    ...
    private get right(): Callable {
        return new Callable("Right", {
            signature: {
                args: [new StdlibArgument("len", ValueKind.Int32)],
                returns: ValueKind.String,
            },
     ...
     */
    private get replace(): Callable {
        return new Callable("Replace", {
            signature: {
     ...
     */
    private get trim(): Callable {
        return new Callable("Trim", {
            signature: {
                args: [],
                returns: ValueKind.String,
            },
    ...
    private get toInt(): Callable {
        return new Callable("ToInt", {
            signature: {
                args: [],
                returns: ValueKind.Int32,
            },
    ...
    private get toFloat(): Callable {
        return new Callable("ToFloat", {
            signature: {
                args: [],
     ...
     */
    private get tokenize(): Callable {
        return new Callable("Tokenize", {
            signature: {
     ...
     */
    private get split(): Callable {
        return new Callable("Split", {
            signature: {
     ...
     * entity encoding.
     */
    private get getEntityEncode(): Callable {
        return new Callable("GetEntityEncode", {
            signature: {
                args: [],
                returns: ValueKind.String,
            },
    ...
    private get escape(): Callable {
        return new Callable("Escape", {
            signature: {
                args: [],
                returns: ValueKind.String,
            },
    ...
    private get unescape(): Callable {
        return new Callable("Unescape", {
            signature: {
                args: [],
                returns: ValueKind.String,
            },
    ...
    private get isEmpty(): Callable {
        return new Callable("isEmpty", {
            signature: {
                args: [],
     ...
     * (URI) characters.
     */
    private get encodeUri(): Callable {
        return new Callable("EncodeUri", {
            signature: {
                args: [],
                returns: ValueKind.String,
            },
     ...
     * (URI) characters.
     */
    private get decodeUri(): Callable {
        return new Callable("DecodeUri", {
            signature: {
                args: [],
                returns: ValueKind.String,
            },
     ...
     */
    private get encodeUriComponent(): Callable {
        return new Callable("EncodeUriComponent", {
            signature: {
                args: [],
                returns: ValueKind.String,
            },
    ...
    private get decodeUriComponent(): Callable {
        return new Callable("DecodeUriCOmponent", {
            signature: {
                args: [],
                returns: ValueKind.String,
            },
    ...
    private get startsWith(): Callable {
        return new Callable("startsWith", {
            signature: {
                args: [
    ...
    private get endsWith(): Callable {
        return new Callable("endsWith", {
            signature: {
                args: [
                    new StdlibArgument("matchString", ValueKind.String),
                    new StdlibArgument("position", ValueKind.Int32, BrsInvalid.Instance),
