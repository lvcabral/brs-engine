...
> 🚨 Important:
>
> Since v1.9.1, this package no longer brings the **CLI** app and **Node.js** libraries for the **simulation engine**, for those use cases we created the new [brs-node](https://www.npmjs.com/package/brs-node?activeTab=versions) package. Check it out!
