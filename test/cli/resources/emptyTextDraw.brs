sub main()
    ' Regression: node-canvas v4-rc1 aborts the process (SIGTRAP) when measureText/fillText
    ...
    ' node-canvas v4-rc1 collapses whitespace-only strings to width 0; the engine
