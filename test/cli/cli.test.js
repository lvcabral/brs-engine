...
describe("cli", () => {
    ...
    it("SceneGraph App Test", async () => {
        ...
        expect(stdout.split("\n").map((line) => line.trimEnd())).toEqual([
            ...
            "Main -----------------------------------------------",
            "MAIN: node.link: http://www.example.com/image.jpg",
            "MAIN: copy.link: http://www.example.com/image.jpg",
            "MAIN: clone.link: http://www.example.com/image.jpg",
            "MAIN: node.aa.name: changed",
            "MAIN: copy.aa.name: changed",
            "MAIN: clone.aa.name: one",
            "MAIN: node.boxedInt:  10",
            "MAIN: copy.boxedInt:  10",
            "MAIN: clone.boxedInt:  5",
            "MAIN: isSameObject(node.aa, copy.aa): false",
            "MAIN: isSameObject(node.aa, clone.aa): false",
            " 1",
