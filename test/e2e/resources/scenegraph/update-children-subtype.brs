        ...
        children: [
            {
                ...
                children: [
                    {
                        title: "Level 2 - Inherited Node"
                        children: [
                            {
                                title: "Level 3 - Still Node"
                            }
                        ]
                    },
                    {
                        subtype: "ContentNode"
                        title: "Level 2 Switch to ContentNode"
                        children: [
                            {
                                title: "Level 3 Inherited ContentNode"
                            }
