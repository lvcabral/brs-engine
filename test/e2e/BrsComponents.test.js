...
describe("end to end brightscript functions", () => {
    ...
    test("components/ifArraySizeInfo.brs", async () => {
        await execute([resourceFile("components", "ifArraySizeInfo.brs")], outputStreams);
        expect(allArgs(outputStreams.stdout.write).map((arg) => arg.trimEnd())).toEqual([
            "roByteArray -------> isResizable = false",
            "start count: 0 capacity: 4000",
            "end count: 4000 capacity: 4000",
            "roByteArray -------> isResizable = true",
            "start count: 0 capacity: 0",
            "count: 1 capacity: 16 diff: 16",
            "count: 17 capacity: 32 diff: 16",
            "count: 33 capacity: 48 diff: 16",
            "count: 49 capacity: 64 diff: 16",
            "count: 65 capacity: 80 diff: 16",
            "count: 81 capacity: 100 diff: 20",
            "count: 101 capacity: 125 diff: 25",
            "count: 126 capacity: 156 diff: 31",
            "count: 157 capacity: 195 diff: 39",
            "count: 196 capacity: 243 diff: 48",
            "count: 244 capacity: 303 diff: 60",
            "count: 304 capacity: 378 diff: 75",
            "count: 379 capacity: 472 diff: 94",
            "count: 473 capacity: 590 diff: 118",
            "count: 591 capacity: 737 diff: 147",
            "count: 738 capacity: 921 diff: 184",
            "count: 922 capacity: 1151 diff: 230",
            "count: 1152 capacity: 1438 diff: 287",
            "count: 1439 capacity: 1797 diff: 359",
            "count: 1798 capacity: 2246 diff: 449",
            "count: 2247 capacity: 2807 diff: 561",
            "count: 2808 capacity: 3508 diff: 701",
            "count: 3509 capacity: 4385 diff: 877",
            "end count: 4001 capacity: 4385",
            "roArray -------> isResizable = false",
            "start count: 0 capacity: 4000",
            "end count: 4000 capacity: 4000",
            "roArray -------> isResizable = true",
            "start count: 0 capacity: 1",
            "count: 2 capacity: 11 diff: 10",
            "count: 12 capacity: 21 diff: 10",
            "count: 22 capacity: 31 diff: 10",
            "count: 32 capacity: 41 diff: 10",
            "count: 42 capacity: 51 diff: 10",
            "count: 52 capacity: 63 diff: 12",
            "count: 64 capacity: 78 diff: 15",
            "count: 79 capacity: 97 diff: 19",
            "count: 98 capacity: 121 diff: 24",
            "count: 122 capacity: 151 diff: 30",
            "count: 152 capacity: 188 diff: 37",
            "count: 189 capacity: 235 diff: 47",
            "count: 236 capacity: 293 diff: 58",
            "count: 294 capacity: 366 diff: 73",
            "count: 367 capacity: 457 diff: 91",
            "count: 458 capacity: 571 diff: 114",
            "count: 572 capacity: 713 diff: 142",
            "count: 714 capacity: 891 diff: 178",
            "count: 892 capacity: 1113 diff: 222",
            "count: 1114 capacity: 1391 diff: 278",
            "count: 1392 capacity: 1738 diff: 347",
            "count: 1739 capacity: 2172 diff: 434",
            "count: 2173 capacity: 2715 diff: 543",
            "count: 2716 capacity: 3393 diff: 678",
            "count: 3394 capacity: 4241 diff: 848",
    ...
    test("components/roUtils.brs", async () => {
        ...
        expect(allArgs(outputStreams.stdout.write).map((arg) => arg.trimEnd())).toEqual([
            ...
            "isSameNode(node:Child, copy:Child): true",
            "isSameNode(node:Child, clone:Child): false",
            "isSameNode(node:Grandchild, copy:Grandchild): true",
            " 1",
            "<Component: roAssociativeArray> =\n{\n}",
            "<Component: roArray> =\n[\n    10\n    2\n    3\n]",
            "<Component: roAssociativeArray> =\n" +
