Sub Main()
	...
	mp3 = CacheFile("https://ia904509.us.archive.org/15/items/ConversandoMioloDePotePodcastT01E01/Conversando-Miolo-de-Pote-Podcast-T01E01.mp3", "podcast.mp3")
...
function SaveCoverArtFile(filename As String)
    ...
    print ts.TotalMilliseconds(); "ms to load metadata"
    ts.Mark()
    print "------------- GetTags() -------------------------"
    tags = meta.GetTags()
    print ts.TotalMilliseconds(); "ms to get tags"
    print tags
