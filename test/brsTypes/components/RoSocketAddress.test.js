    ...
    describe("methods", () => {
        ...
        describe("getAddress", () => {
            it("should return default address", async () => {
                ...
                expect(await method.call(interpreter)).toEqual(new BrsString("0.0.0.0:0"));
            });
        });
        describe("getHostName", () => {
            it("should return default host", async () => {
                ...
                expect(method).toBeTruthy();
                expect(await method.call(interpreter)).toEqual(new BrsString("0.0.0.0"));
            });
        });
        describe("getPort", () => {
        ...
        describe("isAddressValid", () => {
            it("should return as valid address", async () => {
                let obj = new RoSocketAddress(interpreter);
        ...
        describe("setAddress", () => {
            it("should return as true", async () => {
                let obj = new RoSocketAddress(interpreter);
                ...
                expect(method).toBeTruthy();
                expect(await method.call(interpreter, new BrsString("roku.com:8080"))).toEqual(
                    BrsBoolean.True
                );
                expect(await host.call(interpreter)).toEqual(new BrsString("roku.com"));
                expect(await port.call(interpreter)).toEqual(new Int32(8080));
            });
        });
        describe("setHostName", () => {
            it("should return as true", async () => {
                ...
                expect(method).toBeTruthy();
                expect(await method.call(interpreter, new BrsString("google.com"))).toEqual(
                    BrsBoolean.True
                );
                expect(await host.call(interpreter)).toEqual(new BrsString("google.com"));
            });
        });
        describe("setPort", () => {
            it("should return as true", async () => {
                ...
                expect(method).toBeTruthy();
                expect(await method.call(interpreter, new Int32(7070))).toEqual(BrsBoolean.True);
                expect(await port.call(interpreter)).toEqual(new Int32(7070));
            });
        });
    });
});
